...
import 'package:wkwp_mobile/Components/IncidentBars/RMFIncidentBar.dart';
...
class RMFList extends StatefulWidget {
  const RMFList({Key? key}) : super(key: key);

  @override
  State<RMFList> createState() => _RMFListState();
}

class _RMFListState extends State<RMFList> {
  String start = '';
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: RMFIncidentBar(item: item, name: name),
                              );
                            },
                          )
                        : isLoading == null
